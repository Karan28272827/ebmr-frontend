  ...
  const columns = [
    { title: 'Code', dataIndex: 'vendor_code', key: 'vendor_code' },
    {
      ...
      render: (v: string, r: any) => (
        <Button type="link" onClick={() => navigate(`/vendors/${r.id}`)}>
          {v}
        </Button>
      ),
    },
    ...
    <div>
      ...
      >
        <Form form={form} layout="vertical" onFinish={handleCreate}>
          ...
          <Form.Item name="materials_supplied" label="Materials Supplied">
            <Select mode="tags" placeholder="Enter material codes" />
          </Form.Item>
