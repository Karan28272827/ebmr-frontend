        ...
        prev.map((m) =>
          m.id === loadingId
            ? {
                ...m,
                isLoading: false,
                content: 'Could not connect to the knowledge base. Please try again.',
              }
            : m,
        ),
      );
    ...
    <>
      ...
      {open && (
        ...
        >
          {/* Header */}
          <div
            style={{ padding: '12px 16px', background: '#1677ff', color: '#fff', flexShrink: 0 }}
          >
            <div style={{ fontWeight: 600, fontSize: 15 }}>eBMR Knowledge Assistant</div>
            <div style={{ fontSize: 12, opacity: 0.85 }}>
              Search SOPs, QC specs, batch records & deviations
            </div>
          </div>
                        ...
                        <>
                          ...
                          {msg.sources?.map((src, i) => (
                            ...
                            >
                              ...
                              >
                                <Tag
                                  color={SOURCE_LABELS[src.source_type]?.color || 'default'}
                                  style={{ margin: 0 }}
                                >
                              ...
                              <div
                                style={{ color: '#333', lineHeight: 1.5, whiteSpace: 'pre-line' }}
                              >
